...
class UserService {
  ...
  // Add health metrics
  Future<DocumentReference> addHealthMetrics(HealthMetrics metrics) async {
    try {
      // Remove metricId from the JSON since it will be generated by Firestore
      final data = metrics.toJson();
      data.remove('metricId');
      // Convert DateTime to Timestamp for Firestore
      data['recordedAt'] = Timestamp.fromDate(metrics.recordedAt);
      print('Adding health metrics to Firestore: $data');
      final docRef = await _firestore.collection('health_metrics').add(data);
      print('Successfully added document with ID: ${docRef.id}');
      return docRef;
    } catch (e) {
      print('Error in addHealthMetrics: $e');
      rethrow;
    }
  }
